...
| AI data handling, FERPA readiness & cloud-provider terms | [docs/AI_DATA_HANDLING_AND_CLOUD_PROVIDER_TERMS.md](./docs/AI_DATA_HANDLING_AND_CLOUD_PROVIDER_TERMS.md) |
