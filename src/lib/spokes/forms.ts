...
export const FORMS: SpokesForm[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    description: "Introduction to the SPOKES program and what to expect",
    category: "onboarding",
    fileName: "(1)New Student Welcome Letter 2024.docx",
    fillable: false,
    required: true,
    audience: "student",
    sortOrder: 1,
  ...
  },
  {
    ...
    description:
      "Consent for sharing your information between program partners",
    category: "onboarding",
    fileName: "SPOKES Authorization for Release of Information.pdf",
    fillable: false,
    required: true,
    audience: "student",
    sortOrder: 6,
  ...
  },
  {
    ...
    category: "onboarding",
    fileName: "Media_Release_Form_FY26.docx",
    fillable: false,
    required: false,
    audience: "student",
    sortOrder: 8,
  ...
  },
  {
    ...
    description:
      "Tracks the documents you'll collect for your employment portfolio",
    category: "onboarding",
  ...
  },
  {
    ...
    category: "onboarding",
    fileName: "(11)Learning_Needs_Screening_Instrument_2021.22.pdf",
    fillable: false,
    required: true,
    audience: "student",
    sortOrder: 11,
  },
  {
    ...
    category: "onboarding",
    fileName: "(12)CTE Learning Styles.docx",
    fillable: false,
    required: true,
    audience: "student",
    sortOrder: 12,
  },
  {
    ...
    category: "onboarding",
    fileName: "(13)Non-Discrimination_Notice.docx",
    fillable: false,
    required: true,
    audience: "student",
    sortOrder: 13,
  },
  {
    ...
    description:
      "Secure template for tracking your platform login credentials",
    category: "onboarding",
    fileName: "Password-log-template-7.pdf",
    fillable: false,
    required: false,
    audience: "student",
    sortOrder: 14,
  },
  {
    ...
    description: "CFWV career exploration and self-assessment worksheet",
    category: "onboarding",
    fileName: "CFWV Career Exploration Worksheet.docx",
    fillable: false,
    required: false,
    audience: "student",
    sortOrder: 15,
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    category: "compliance",
    fileName: "SPOKES Student Sign-in-Sheet.pdf",
    fillable: false,
    required: true,
    audience: "both",
    sortOrder: 1,
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    category: "portfolio",
    fileName: "Employment Portfolio Checklist.pdf",
    fillable: false,
    required: true,
    audience: "student",
    sortOrder: 1,
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    fileName: "Ready to Work Attendance Verification Form.pdf",
    fillable: false,
    required: true,
    audience: "both",
    sortOrder: 1,
  },
  {
    ...
    title: "SPOKES Module Record FY26",
    description: "Tracks completion of required SPOKES program modules",
    category: "certification-tracking",
    fileName: "SPOKES_Module_Record_FY26.docx",
    fillable: false,
    required: true,
    audience: "both",
    sortOrder: 2,
