...
export function sanitizeForPrompt(value: string): string {
  return value
    .replace(
      /\[\s*(STUDENT_NAME|STUDENT_GOAL|STUDENT_GOALS|STUDENT_CONTEXT|CAREER_PROFILE|DISCOVERY|SKILL_GAP|PATHWAY|COACHING_ARC|STAFF_STUDENT_CONTEXT)_(START|END)\s*\]/gi,
      "",
    )
