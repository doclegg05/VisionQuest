...
/**
 * Document-based context (`getDocumentContext`) lives in
 * `./knowledge-base-server.ts` — it touches Prisma, which would drag
 * `node:async_hooks` into client bundles if imported from this module.
 */
