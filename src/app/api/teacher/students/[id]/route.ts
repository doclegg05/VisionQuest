    ...
    select: {
      ...
      careerDiscovery: {
        select: {
          ...
          hollandCode: true,
          riasecSource: true,
          riasecInstrument: true,
          riasecAssessedAt: true,
  ...
  return NextResponse.json({
    ...
    careerDiscovery: student.careerDiscovery
      ? {
          ...
          riasecSource: student.careerDiscovery.riasecSource,
          riasecInstrument: student.careerDiscovery.riasecInstrument,
          riasecAssessedAt: student.careerDiscovery.riasecAssessedAt,
