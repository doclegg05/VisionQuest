...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    logger.error("Vision board create error", { error: String(error) });
...
export async function PUT(req: NextRequest) {
  ...
  try {
    ...
    logger.error("Vision board update error", { error: String(error) });
...
export async function DELETE(req: NextRequest) {
  ...
  try {
    ...
    logger.error("Vision board delete error", { error: String(error) });
