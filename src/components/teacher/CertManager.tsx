        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
          ...
          <div className="flex flex-wrap gap-4">
            <label className="flex items-center gap-2 text-sm text-gray-600">
              <input type="checkbox" checked={form.required} onChange={(e) => setForm({ ...form, required: e.target.checked })} className="rounded border-gray-300 text-blue-600" />
              Required
            </label>
            <label className="flex items-center gap-2 text-sm text-gray-600">
              <input type="checkbox" checked={form.needsFile} onChange={(e) => setForm({ ...form, needsFile: e.target.checked })} className="rounded border-gray-300 text-blue-600" />
              File upload needed
            </label>
            <label className="flex items-center gap-2 text-sm text-gray-600">
              <input type="checkbox" checked={form.needsVerify} onChange={(e) => setForm({ ...form, needsVerify: e.target.checked })} className="rounded border-gray-300 text-blue-600" />
