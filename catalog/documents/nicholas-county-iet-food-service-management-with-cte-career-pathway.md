...
title: Nicholas County IET Food Service Management with CTE Career Pathway
description: >-
  A concrete local IET (Integrated Education and Training) course plan — the
  Food Service Manager pathway with CTE for Nicholas County (Britt's
  Summersville site) — showing schedule, entry points, assessments, and the
  career-exploration components of a real pathway offering.
resource: students/resources/Nicholas_County_IET_Food_Service_Management_with_CTE_Career_Pathway.docx
tags:
  - iet
  - career-pathway
  - food-service
...
vq_id: nicholas-county-iet-food-service-management-with-cte-career-pathway
vq_audience: STUDENT
vq_category: STUDENT_RESOURCE
vq_storage_key: students/resources/Nicholas_County_IET_Food_Service_Management_with_CTE_Career_Pathway.docx
vq_status: approved
---
## When to use
